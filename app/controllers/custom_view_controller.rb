class CustomViewController < ApplicationController
  ...
  def update
    unless params[:view_parameters]
      webmasterEmail = InstallationHelper.CURRENT_INSTALLATION.webmasterEmail
      render :text => "If you see this message and you aren't a search engine, please contact " + webmasterEmail, :status => 404
      return
    end
