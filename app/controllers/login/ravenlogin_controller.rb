...
class Login::RavenloginController < ApplicationController
 ...
 @@raven_settings = RAVEN_SETTINGS
  ...
  def other_users_login
    redirect_to login_url(:action => 'other_users') 
  end
